...
public class Constants {
    ...
    public static final String PROFILE_HEADER_NAME="PROFILE-ID";
    ...
    public final static String PASSWORD_REGEX="^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&+=_-])(?=\\S+$).{8,}$";

    public final static String MATHPAR_CORRECT_ANSWER_KEY = "YES";
}
